...
# Aseguramos que los datos no tengan valores nulos
...
# Hasta este punto, preparamos la matriz X, donde la primera columna es de unos (para el intercepto β0), y las demás columnas son las características.
...
# Calcular la correlación entre y y y_pred
...
# Muestro las primeras 5 predicciones junto a los valores reales
