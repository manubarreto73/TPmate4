...
# Quito los valores nulos de los datos
...
# Inicializar los coeficientes (pesos) β
...
# Muestro los coeficientes obtenidos
print("\nCoeficientes finales (β):")
print(f"Intercepto (β0): {beta[0]}")
for i, feature in enumerate(features):
    print(f"Coeficiente para {feature} (β{i+1}): {beta[i+1]}")

# Calculo las predicciones finales
y_pred_final = X @ beta

# Calculo el coeficiente de determinación (R²) para evaluar el modelo
